...
- 3:4 封面卡的主视觉要紧跟标题和 lead，不能沉到底部，也不能在页面中段留下大块空白；封面图可轻微裁切来增强海报感，但不能切掉主要信息。
...
5. 读 `references/testing-lessons.md`。
6. 复制或改造 `assets/template.html`。
7. 替换 slide 数据和图片路径。
8. 浏览器验证后再交付。
