...
它适合把长文、教程、讲稿、公众号文章、图片素材目录，制作成适合录屏讲解的 16:9 HTML 翻页 PPT，也可以生成适合图文发布的 3:4 竖版 HTML 卡片。重点不是做普通摘要，而是做一份观众能跟着学、或者读者能逐页读懂的教学型内容。
...
index.html?mode=cards&style=rounded
index.html?mode=cards&style=bold
```
